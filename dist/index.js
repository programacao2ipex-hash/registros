...
async function getDocumentRecordById(id) {
  const db = await getDb();
  if (!db) {
    throw new Error("Database not available");
  }
...
var appRouter = router({
  ...
  documentRecords: router({
    create: protectedProcedure.input(z2.object({
      ...
      onlinePlatform: z2.string().optional(),
      signedBy: z2.string().min(1),
      signedByOther: z2.string().optional(),
      signatureDate: z2.date(),
      responsible: z2.string().min(1),
      responsibleOther: z2.string().optional()
